...
/**
 * Native GitHub Auto-Updater for WordPress Plugin (v2.0.3)
...
class UPR_GitHub_Updater {
	...
	public function post_install( $true, $hook_extra, $result ) {
		...
		$proper_folder = WP_PLUGIN_DIR . '/universal-post-rss-loop';
		$install_directory = isset( $result['destination'] ) ? $result['destination'] : '';

		if ( ! empty( $install_directory ) && rtrim( $install_directory, '/\\' ) !== rtrim( $proper_folder, '/\\' ) ) {
			...
			$result['destination_name'] = 'universal-post-rss-loop';
		}
